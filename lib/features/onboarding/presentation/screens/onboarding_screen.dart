...
import 'package:servi_pro/features/onboarding/presentation/widgets/onboarding_page.dart';
import 'package:servi_pro/features/onboarding/presentation/widgets/page_indicator.dart';
...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  void _next(int currentPage) async {
    if (currentPage < _pages.length - 1) {
      ...
      await ref.read(onboardingLocal.notifier).setOnboarding(true);
      Navigator.of(
        context,
